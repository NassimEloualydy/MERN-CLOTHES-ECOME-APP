...
const {submitProduct,getProductFormHome,getProductInfo,deleteProduct,getPhoto,getData,getProductTypes}=require("../controller/productController")
...
Router.post("/getProductFormHome",auth,getProductFormHome);
